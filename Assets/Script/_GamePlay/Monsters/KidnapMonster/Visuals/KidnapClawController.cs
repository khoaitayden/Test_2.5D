using UnityEngine;
public class KidnapClawController : MonoBehaviour
{
    [Header("Animation")]
    [SerializeField] private Animator animator;
    [SerializeField] private string blendParamName = "GrabBlend";
    ...
    void Awake()
    {
        animGrabHash = Animator.StringToHash(blendParamName);
